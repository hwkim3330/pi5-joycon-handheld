...
> geometry: five (exact) / four (acrylzip) small pieces, two M2.5 clamp bolts,
> slide a Joy-Con in from the open end. Only then order the case. The slot has never been cut in acrylic.
